...
namespace E_Commerce.Infastructure.Migrations
{
    ...
    [Migration("20250821140550_AddExlogins")]
    partial class AddExlogins
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("E_Commerce.Core.Entites.ApplicationUser", b =>
                {
            ...
            modelBuilder.Entity("E_Commerce.Core.Entites.ExternalLogin", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("E_Commerce.Core.Entites.ExternalLogin", b =>
                {
                    b.HasOne("E_Commerce.Core.Entites.ApplicationUser", "User")
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("E_Commerce.Core.Entites.ApplicationUser", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
